...
public class ExampleWithDDF {
	...
	// Enter Username
	String Username =WorkbookFactory.create(file).getSheet("LoginData").getRow(1).getCell(0).getStringCellValue();

	driver.findElement(By.xpath("//input[@name=\"username\"]")).sendKeys(Username);

	// Enter Passowrd
	FileInputStream File2 = new FileInputStream(path);
	String Password =WorkbookFactory.create(File2).getSheet("LoginData").getRow(1).getCell(1).getStringCellValue();
